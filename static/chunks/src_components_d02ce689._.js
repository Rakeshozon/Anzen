...
function AttractionCard({ attraction }) {
    const imageUrl = attraction.images[0] || "https://picsum.photos/seed/placeholder/400/300";
...
function AttractionsTabs({ attractions: initialAttractions }) {
    ...
    const filteredAttractions = activeTab === 'All' ? initialAttractions : initialAttractions.filter((attraction)=>attraction.category === activeTab);
...
_s(AttractionsTabs, "1k6lhePRljloIu0Vz/5Kfpi6iMY=");
_c = AttractionsTabs;
var _c;
...
//# sourceMappingURL=src_components_d02ce689._.js.map